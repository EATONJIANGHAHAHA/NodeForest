...
var TreeSQL = {
    ...
    getById:'SELECT max(p.upload_date) AS upload_date, t.id, t.name, t.sayings, t.species, l.location, l.path AS location_image, t.health, t.last_edit from photo p join tree t on t.id = p.tree_id join location l on l.id = t.location_id WHERE p.tree_id = ? ',
